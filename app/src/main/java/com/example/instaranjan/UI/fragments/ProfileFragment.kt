...
import com.example.instaranjan.Adapters.ViewPagerAdapter
import com.example.instaranjan.R
import com.example.instaranjan.UI.activities.EditProfileActivity
import com.example.instaranjan.ViewModel.SharedViewModel
import com.example.instaranjan.models.User
import com.example.instaranjan.utils.FOLLOWER
import com.example.instaranjan.utils.FOLLOWING
...
class ProfileFragment : Fragment() {
   ...
   lateinit var currentUser: User
    ...
    override fun onPrepareOptionsMenu(menu: Menu) {
        ...
        val myProfileToolbarThreeDotItem: MenuItem? = menu.findItem(R.id.myprofileToolbarThreeDot)
        ...
        myProfileToolbarThreeDotItem?.isVisible = shouldShowAddItem
    }
